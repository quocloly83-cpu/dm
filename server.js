...
async function syncLatestStore() {
  try {
    if (hasGithubStore()) {
      keys = normalizeAllStore(await readGithubStore());
    } else {
    ...
    console.error("Sync latest store failed:", err.message);
  }
  return keys;
}
      ...
      <div class="homeGlass">
        ...
        <div class="loginPanel">
          ...
          <div class="grid2" style="margin-top:10px">
            ...
            <a class="socialBtn" href="${TIKTOK_URL}" target="_blank" rel="noopener noreferrer">${iconTikTok()} <span>TikTok</span></a>
          </div>
